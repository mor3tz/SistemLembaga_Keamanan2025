                                ...
                                <div class="card-body">
                                  <div class="d-sm-flex justify-content-between align-items-start">
                                    <div>
                                      ...
                                      <p class="card-subtitle card-subtitle-dash">Berdasarkan Laporan Petugas Keamanan</p>
                                    </div>
                                    <div>
                                      <div class="dropdown">
                                        <button class="btn btn-light dropdown-toggle toggle-dark btn-lg mb-0 me-0" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Kategori </button>
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                          <h6 class="dropdown-header">Kasus</h6>
                                          <a class="dropdown-item" href="#" data-kategori="Kriminal">Kriminal</a>
                                          <a class="dropdown-item" href="#" data-kategori="Bencana">Bencana Alam</a>
                                    ...
                                    <table class="table select-table">
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td>
                                            <div class="badge badge-opacity-warning">02.03 AM</div>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                            ...
                            <div class="card-body">
                              ...
                              <div class="pe-2">
                                <div class="chart">
                                  <canvas
                                    id="chart-doughnut"
                                    class="chart-canvas small-doughnut" style="height: 500px;"></canvas>
                                </div>
                              </div>
