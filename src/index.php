        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="assets/images/user1.png" alt="Profile image"> </a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/tables/anggota.php">
              <i class="menu-icon mdi mdi-account-group"></i>
              <span class="menu-title">Anggota Keamanan</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages/absensi_petugas.php">
              <i class="menu-icon mdi mdi-format-list-bulleted"></i>
              <span class="menu-title">Absensi</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages/laporan_petugas.php">
              <i class="menu-icon mdi mdi-format-list-bulleted"></i>
                  ...
                  <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                    ...
                    <div class="row">
                          ...
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  <div>
                                    <h4 class="card-title card-title-dash">Riwayat Laporan Petugas</h4>
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td class="td-keterangan ">
                                          <p class=" fw-bold">PERKELAHIAN TAWURAN</p>
                                        </td>
                                        <td>
                                          <div class="badge badge-opacity-info fw-bold">10 MEI 2025</div>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>
                                      ...
                                      <tr>
                                        ...
                                        <td class="td-keterangan">
                                          <p class=" fw-bold">MIRAS DAN NARKOBA</p>
                                        </td>
                                        <td>
                                          <div class="badge badge-opacity-info fw-bold">10 MEI 2025</div>
                                        </td>
                      ...
                      <!-- <div class="col-lg-4 col-md-4 mt-4">
                        <div class="card">
                          <div class="card-body">
                            <h6 class="mb-0">Tingkat Keamanan Wilayah</h6>
                            <p class="text-sm">Persentase tingkat keamanan wilayah</p>
                            <div class="pe-2">
                              <div class="chart">
                                <canvas id="chart-doughnut" class="chart-canvas small-doughnut" style="height: 300px;"></canvas>
                              </div>
                            </div>
