      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
  <a class="nav-link active" href="../../pages/tables/anggota.php">
    ...
    <span class="menu-title">Anggota Keamanan</span>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 mx-auto grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <ing class="card-title">Anggota Keamanan Siskamling</h4>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <a href="#" class="action-link text-info me-2">
          ...
          <footer class="footer">
            <div class="d-smlex justify-content-center justify-content-sm-between">
