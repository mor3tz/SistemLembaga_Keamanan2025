        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/absensi_petugas.php">
              <i class="menu-icon mdi mdi-table"></i>
              <span class="menu-title">Items 1</span>
            </a>
          </li>
          <li class="nav-item">
            ...
            <div class="content-wrapper">
              <div class="row">
                <div class="col-lg-12 mx-auto grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Daftar Hadir Anggota Keamanan Linmas</h4>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>53275534</td>
                              <td>Linmas</td>
                              <td><label class="badge badge-danger">Tanpa Keterangan</label></td>
                              <td>13 Mei 2025</td>
                            </tr>
                            <tr>
                              <td>RUSLAN</td>
